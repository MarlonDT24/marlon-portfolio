                    ...
                    <div className="p-6 md:p-10 grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-10">
                                ...
                                <div>
                                    ...
                                    <div className="grid gap-4 sm:grid-cols-2">
                                        {data.strategies.map((strat, idx) => (
                                            <div key={idx} className="bg-white/5 p-4 rounded-xl border border-white/5 hover:border-emerald-500/30 transition-colors">
                                                <div className="flex items-start gap-3">
                                                    <CheckCircle2 className="text-emerald-500 mt-1 min-w-5" size={20} />
                                                    <div>
                                                        <h4 className="text-white font-bold text-sm mb-1">{strat.title}</h4>
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="bg-white/5 p-6 rounded-2xl border border-white/10">
                                <h4 className="text-slate-400 text-sm font-bold uppercase mb-4">Enlaces del Proyecto</h4>
                            ...
                            {/* Caja de Tecnologías */}
                            <div className="bg-white/5 p-6 rounded-2xl border border-white/10">
                                <h4 className="text-slate-400 text-sm font-bold uppercase mb-4">Tech Stack</h4>
                                <div className="flex flex-wrap gap-2">
                                    {data.techStack.map((tech, i) => (
                                        <div key={i} className="flex items-center gap-2 px-3 py-2 bg-black/40 rounded-lg text-slate-300 border border-white/5 text-sm">
